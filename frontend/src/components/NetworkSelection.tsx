...
interface SimliarityFileRowProps {
    handleRowWeightChange: (weight: number, index: number) => void;
    handleRowFileChange: (event: React.ChangeEvent<HTMLInputElement>, index: number) => Promise<void>;
    rowWeight: number;
    i: number;
};
